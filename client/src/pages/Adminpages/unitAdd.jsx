...
const SuperAdminUnitControl = () => {
  ...
  const handleAddUnit = async (e) => {
    e.preventDefault();
    try {
      // const result = await dispatch(addUnitAPI(newUnit)).unwrap();
      ...
      setError("Failed to add new unit.");
    }
  };
    ...
    <div className="font-sans min-h-screen bg-neutral-100 flex flex-col lg:flex-row">
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto max-h-screen">
        <div className="max-w-8xl mx-auto">
          ...
          {/* Add Unit Form */}
          {showForm && (
            <form onSubmit={handleAddUnit} className="mb-6 bg-white p-6 rounded-lg shadow-lg space-y-4">
              <div>
