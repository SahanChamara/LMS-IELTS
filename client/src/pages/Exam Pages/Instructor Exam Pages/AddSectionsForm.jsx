          ...
          <div>
            <div className="bg-white/80 backdrop-blur-sm border border-blue-200 rounded-lg shadow-md">
              ...
              <div className="p-6 pt-0 space-y-4">
                ...
                <div>
                  <label htmlFor="section-description" className="block text-sm font-medium text-gray-700">Description</label>
                  <textarea
                ...
                <div>
                  <label htmlFor="section-duration" className="block text-sm font-medium text-gray-700">Duration (minutes) *</label>
                  <input
                    id="section-duration"
                    type="number"
                ...
                <div>
                  <label htmlFor="section-instructions" className="block text-sm font-medium text-gray-700">Instructions</label>
                  <textarea
