...
const Lecdashboard = () => {
  ...
  return (
    <div className="font-sans min-h-screen bg-neutral-100 flex">
      {/* Sidebar */}
      ...
      <main className="flex-1 p-8">
        {/* Welcome Banner */}
        <div className="mb-8 bg-gradient-to-r from-blue-600 to-blue-800 text-white p-6 rounded-lg shadow-lg">
        ...
        {loading ? (
          ...
          <div className="space-y-8">
            {/* Summary Metrics */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-lg flex items-center gap-4 transition-transform hover:scale-105">
                <FiBook className="text-3xl text-blue-600" />
                <div>
                  <h3 className="text-lg font-semibold text-gray-800">Courses</h3>
                  <p className="text-2xl font-bold text-gray-900">{dashboardData.courses.length}</p>
                </div>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg flex items-center gap-4 transition-transform hover:scale-105">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg flex items-center gap-4 transition-transform hover:scale-105">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{dashboardData.announcements.length}</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Recent Students */}
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Recent Students</h3>
                <ul className="space-y-2 mb-4">
